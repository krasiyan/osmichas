	...
	$.extend($.fn,{
		...
		showDrag: function(e){
			...
			var position = function(context){
				...
				var o1 = $(".jTagDrag").offset();
				var o2 = $(context).offset();

				border =   parseInt(jtagdrag.css('borderTopWidth'));
				left_pos = parseInt(o1.left - o2.left) + border;
				top_pos =  parseInt(o1.top - o2.top) + border;
			...
			$(".jTagSaveBtn",container).click(function(){
				...
				o1 = $(this).parent().parent().offset();
				o2 = $(container).offset();

				height = $(this).parent().parent().height();
				width = $(this).parent().parent().width();

				top_pos = o1.top - o2.top;
